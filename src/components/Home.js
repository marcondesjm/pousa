  ...
  return (
    ...
    <HomeSection>
      ...
      <HomeText>
        ...
        Localizada a menos de 300m da Praia de Cima, um lugar perfeito para sua família.<p></p>
        A Pousada Pinheira é o refúgio ideal para quem busca conforto e tranquilidade
        em meio à natureza exuberante. Aproveite suas férias em um ambiente acolhedor
        e desfrute de momentos inesquecíveis.<p></p>
        <ReserveButton />
      </HomeText>
      ...
      Contamos com uma estrutura de 4 churrasqueiras no pátio, garagem privativa e estacionamento exclusivo, espaço para eventos, guarda-sol, internet wirelles.<p></p>
 
 Convidamos você para passar dias inesquecíveis com sua família, nós garantimos o cenário ideal.<p></p>
